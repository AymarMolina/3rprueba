...
export default function ReviewsSection() {
  ...
  if (error) {
    return (
      <div className="max-w-3xl mx-auto my-12 p-4 rounded-lg border border-red-500/40 bg-red-500/10 text-red-300 text-sm font-mono whitespace-pre-wrap">
        <strong>Error cargando reseñas de Google:</strong>
        {"\n"}
        {error}
      </div>
    )
