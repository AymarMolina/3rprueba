...
export default async function GoogleAdsLimaLayout({ children, params }: { children: React.ReactNode; params: any }) {
  ...
  const serviceSchema = buildServiceSchema({
    ...
    nameEn: 'Google Ads Agency in Lima',
    ...
    descriptionEn: 'Professional Google Ads campaign management (Search, PMax, YouTube, Display and Shopping) for companies in Lima, Peru.',
