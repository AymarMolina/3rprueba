...
const COPY = {
  es: {
    ...
    serviceList: [
      ...
      { name: 'Posicionamiento SEO', desc: 'Keyword research, on-page, contenidos, link building y SEO técnico desde S/1,800/mes.', href: '/posicionamiento-seo' },
      { name: 'Diseño y Desarrollo Web', desc: 'Landing pages, sitios corporativos y e-commerce en Shopify, WooCommerce o Next.js a medida.', href: '/servicios/web-development' },
    ],
    coverage: 'Cobertura',
  ...
  en: {
    ...
    serviceList: [
      { name: 'Branding & Visual Identity', desc: 'Logo, brand manual, color palette, typography and applications from $500 USD for US clients.', href: '/servicios/branding' },
      { name: 'Social Media Management', desc: 'Strategy, design, Reels and TikToks, copywriting and community management from $800/mo for US clients.', href: '/servicios/socialmedia' },
      { name: 'Google Ads & SEM', desc: 'Search, Performance Max, YouTube, Display, Shopping and Remarketing with fee from $800/mo for US clients.', href: '/servicios/google-ads' },
      { name: 'SEO Positioning', desc: 'Keyword research, on-page, content, link building and technical SEO from $500/mo for US clients.', href: '/posicionamiento-seo' },
      { name: 'Web Design & Development', desc: 'Landing pages, corporate sites and e-commerce on Shopify, WooCommerce or custom Next.js.', href: '/servicios/web-development' },
    ],
    coverage: 'Coverage',
