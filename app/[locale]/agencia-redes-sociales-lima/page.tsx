...
const COPY = {
  ...
  en: {
    ...
    sub: 'Strategy, Reel and TikTok content, daily community management and Meta + TikTok Ads. Production included from S/1,500/month (~$400 USD).',
    ...
    plans: 'Monthly plans',
    plansList: [
      { title: 'Starter', price: 'From S/1,500/mo (~$400)', desc: '8 monthly pieces, 1 network, 2 Reels or TikToks, community management Mon-Fri, monthly report.' },
      { title: 'Growth', price: 'From S/2,800/mo (~$750)', desc: '12–15 pieces, 2 networks, 4 Reels/TikToks, monthly photo session, community 7 days, monthly report with insights.' },
      { title: 'Premium', price: 'From S/4,500/mo (~$1,200)', desc: '20+ pieces, 3 networks, 6–8 short videos with on-location shoot, senior copywriting, community 7 days, real-time dashboard.' },
    ],
    ...
    paidDesc: 'If you want to move from organic to leads/sales, we add paid distribution with proper pixel and CAPI, lookalike audiences, advantage+ and weekly A/B creative testing. Management fee from S/1,500/month on top, recommended minimum S/1,500 monthly ad spend.',
