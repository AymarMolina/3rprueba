...
const COPY = {
  es: {
    ...
    sub: 'Páginas web a medida, sitios corporativos y e-commerce optimizados para velocidad, conversión y SEO. Desde S/2,500 con SEO técnico incluido.',
    ...
    tiersList: [
      { title: 'Landing page', price: 'Desde S/2,500', desc: 'Página de 1 a 3 secciones, formulario, integración WhatsApp, SEO técnico básico y deploy. 2–3 semanas.' },
  ...
  en: {
    ...
    sub: 'Custom websites, corporate sites and e-commerce optimized for speed, conversion and SEO. From S/2,500 (~$670 USD) with technical SEO included.',
    ...
    tiersList: [
      { title: 'Landing page', price: 'From S/2,500 (~$670)', desc: '1–3 sections, contact form, WhatsApp integration, basic technical SEO and deploy. 2–3 weeks.' },
      { title: 'Corporate website', price: 'From S/4,500 (~$1,200)', desc: '5–8 sections (home, about, services, blog, contact), WordPress or Next.js CMS, optional multilingual. 4–6 weeks.' },
      { title: 'Shopify / WooCommerce e-commerce', price: 'From S/6,500 (~$1,750)', desc: 'Store with catalog, Culqi/Niubiz/Izipay gateways, shipping, VAT, discounts, abandoned cart and admin dashboard. 6–10 weeks.' },
      { title: 'Custom Next.js website', price: 'From S/9,500 (~$2,550)', desc: 'Headless CMS (Sanity, Supabase), GSAP/Framer animations, API integrations, multilingual and Vercel deploy. 8–14 weeks.' },
    ],
