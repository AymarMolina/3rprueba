...
const COPY = {
  es: {
    ...
    sub: 'Posicionamiento orgánico en Google con auditoría técnica, contenidos optimizados, link building blanco y SEO local por distrito. Desde S/1,500/mes y sin contratos forzosos.',
    ...
    pricingDesc: 'Tier Local Pyme desde S/1,500/mes · Tier Competitivo desde S/3,000/mes · Tier Enterprise desde S/5,000/mes. Precios netos, factura electrónica suma 18% de IGV. Mínimo 3 meses recomendado para resultados visibles.',
  ...
  en: {
    ...
    sub: 'Organic Google positioning with technical audit, optimized content, white-hat link building and local SEO by district. From S/1,500/month (~$400 USD) with no forced contracts.',
    ...
    pricingDesc: 'Local SMB tier from S/1,500/month (~$400 USD) · Competitive tier from S/3,000/month (~$800 USD) · Enterprise tier from S/5,000/month (~$1,350 USD). Net prices, Peruvian invoices add 18% VAT. Minimum 3 months recommended for visible results.',
